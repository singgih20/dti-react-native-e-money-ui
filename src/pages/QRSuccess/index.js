...
export default function QRSuccess({ navigation, route }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.info}>
                <Text style={styles.textInfo1}>20 Agustus 2020</Text>
                <Text style={styles.textInfo2}>Penerima: DTI Telkom University</Text>
